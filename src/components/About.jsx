...
function About() {
  return (
    <section id="about" className="text-gray-700 body-font mt-[60px]">
    <div className="container mx-auto flex px-5 py-5 md:flex-row flex-col items-center">
      <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
        ...
        <div className="px-2 pt-2 pb-11 mb-3 flex flex-wrap rounded-lg bg-gray-200 dark:bg-gray-400">
          <span className="flex flex-wrap pl-4 pr-2 py-2 m-1 justify-between items-center text-sm font-medium rounded cursor-pointer bg-cyan-500 text-gray-200 hover:bg-cyan-600 hover:text-gray-100 dark:bg-gray-700 dark:text-gray-200 dark:hover:bg-gray-800 dark:hover:text-gray-100">
          #AmbientComputingAnthusiast
        ...
        <div className="flex justify-center">
          <button className="inline-flex items-center bg-cyan-500 border-0 py-1 px-3 focus:outline-none hover:bg-blue-500 rounded text-base text-white mt-4 md:mt-0">My Resume
            <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} className="w-4 h-4 ml-1" viewBox="0 0 24 24">
              <path d="M5 12h14M12 5l7 7-7 7" />
            </svg>
          </button>
          <a href="mailto:iskandar.jn23@gmail.com" className="ml-4 inline-flex text-white bg-sky-500 border-0 py-2 px-6 focus:outline-none hover:bg-gray-300 rounded text-lg">Contact</a>
        </div>
      </div>
