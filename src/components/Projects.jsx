...
function Projects() {
  ...
  const projects = [
    { id: 1, title: 'Blog Admin Backend-express-typescript', description: 'This project represents a RESTful API built with Node.js, TypeScript and Sequelize, an ORM for interacting with databases. The framework suggests organized development, with features such as authentication, file uploads, data validation, and database migrations.',link:'https://github.com/Al-Iskandari/blog-admin-backend-express-typescript', screenshot: 'express-typescript_1.png', sourceLogo:''},
    { id: 2, title: 'Blog Admin React + Vite', description: 'Blog Admin is a web-based admin panel built using React. It includes various UI components, themes, and structured page layouts for easy customization.',link:'https://github.com/Al-Iskandari/blog-admin-frontend-react-vite', screenshot: 'Gemini_Generated_Image_r6ekf5r6ekf5r6ek-removebg-preview.png' },
    { id: 3, title: 'Circle timer with CSS Animation', description: 'Simple circle timer using css animation keyframe to run circle element based on specified duration and roll all circle element along roll specified time.',link:'https://codepen.io/al-iskandari/pen/jENNXgq', screenshot: 'circle_timer_css_animation.png' },
    { id: 4, title: 'Project 4', description: 'Description of Project 4',link:'', screenshot: 'Gemini_Generated_Image_r6ekf5r6ekf5r6ek-removebg-preview.png'},
    { id: 5, title: 'Project 5', description: 'Description of Project 5',link:'', screenshot: 'Gemini_Generated_Image_r6ekf5r6ekf5r6ek-removebg-preview.png' },
    { id: 6, title: 'Project 6', description: 'Description of Project 6',link:'', screenshot: 'Gemini_Generated_Image_r6ekf5r6ekf5r6ek-removebg-preview.png' },
    { id: 7, title: 'Project 7', description: 'Description of Project 7',link:'', screenshot: 'Gemini_Generated_Image_r6ekf5r6ekf5r6ek-removebg-preview.png' },
    { id: 8, title: 'Project 8', description: 'Description of Project 8',link:'', screenshot: 'Gemini_Generated_Image_r6ekf5r6ekf5r6ek-removebg-preview.png' },
    { id: 9, title: 'Project 9', description: 'Description of Project 9',link:'', screenshot: 'Gemini_Generated_Image_r6ekf5r6ekf5r6ek-removebg-preview.png' },
  ];
