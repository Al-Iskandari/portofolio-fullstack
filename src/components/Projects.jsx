...
function Projects(props) {
  ...
  const projects = [
    ...
    { id: 7, title: 'Circle timer with CSS Animation', description: 'Simple circle timer using css animation keyframe to run circle element based on specified duration and roll all circle element along roll specified time.',link:'https://codepen.io/al-iskandari/pen/jENNXgq', placeholder: 'frontend.png', screenshot: 'circle_timer_css_animation.png',sourceLogo:'https://img.icons8.com/?size=64&id=38382&format=png&color=FFFFFF' },
  ];
