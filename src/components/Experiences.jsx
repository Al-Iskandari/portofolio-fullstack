...
function Experiences(props) {
  ...
  return (
    <section ref={innerRef} id="experiences" className={`text-gray-700 body-font border-t border-gray-200 transition-opacity ease-in duration-700 ${isVisible1 ? "opacity-100" : "opacity-0"}`}>
